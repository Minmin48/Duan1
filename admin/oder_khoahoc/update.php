<div class="main-content">
    ...
    <form class="addPro" action="index.php?act=update_status" method="POST">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="ten_lop" value="<?php echo $sua['ten_lop'] ?>" required>
        </div>
        <div class="form-group">
            <label class="form-label">Tên giảng viên</label>
            <input class="form-control" type="text" value="<?php echo $sua['ten_gv'] ?>" name="ten_gv" required>
        </div>
        <div class="form-group">
            <label class="form-label">Thời gian học</label>
            <input class="form-control" type="text" value="<?php echo $sua['thoi_gian_hoc'] ?>" name="thoi_gian_hoc" required>
        </div>
        <div class="form-group">
            <label class="form-label">Ca học</label>
            <input class="form-control" type="text" value="<?php echo $sua['phone'] ?>" name="ca_hoc" required>
        </div>
        <div class="form-group">
            <label class="form-label">Số lượng</label>
            <input class="form-control" type="text" value="<?php echo $sua['so_luong'] ?>" name="so_luong" required>
        </div>
        <div class="form-group">
            <label class="form-label">Học phí</label>
            <input class="form-control" type="text" value="<?php echo $sua['hoc_phi'] ?>" name="hoc_phi" required>
        </div>
        <div class="form-group">
            <label class="form-label">Tên người dùng</label>
            <input class="form-control" type="text" value="<?php echo $sua['ten_nguoi_dung'] ?>" name="ten_nguoi_dung" required>
        </div>
        <div class="form-group">
