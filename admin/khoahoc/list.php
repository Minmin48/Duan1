            ...
            foreach ($khoa_hoc_all as $value) : $index++ ?>
                <tr class="table-primary">
                    ...
                    <td>
                        ...
                        <a href="index.php?act=deletekhoahoc&id=<?php echo $value['id_kh'] ?>" onclick="return confirm('Bạn muốn xóa khóa học không')" class="btn btn-danger"><i class="fa-solid fa-trash"></i> Xóa</a>
