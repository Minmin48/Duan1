        ...
        <?php foreach ($dssp as $value) : ?>
            <div class="col-lg-4 col-sm-6">
                ...
                <div class="single-blog text-center">
                    <div class="blog-img">
                    <a href="index.php?act=ct_giangvien&id=<?php echo $value['id_gv'] ?>"><img style="border-radius:8px" width="1000px" height="300px" src="img/<?php echo $value['hinh_gv'] ?>" alt="Courses"></a>
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                            <span><i class="far fa-user"></i><a href="index.php?act=giangvien&id=<?php echo $value['id_gv'] ?>"><?php echo $value['ten_gv'] ?></a></span>
                            <span><i class="far fa-calendar-alt"></i> 01 Jun, 2023</span>
                        </div>
